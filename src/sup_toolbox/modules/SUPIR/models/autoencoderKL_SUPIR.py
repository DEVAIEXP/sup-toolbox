...
class AutoencoderKLSUPIR(ModelMixin, ConfigMixin):
    r"""
    A model implementing the RobustDenoiseEncoder from SUPIR, designed to encode images into latent representations
...
class AutoencoderKLSUPIR(ModelMixin, ConfigMixin):
    ...
    ) -> Union[AutoencoderKLSUPIROutput, Tuple[torch.Tensor]]:
        """
