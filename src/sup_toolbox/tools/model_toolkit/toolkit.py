...
IDENTIFICATION = {
    "VAE": {"SD-v1": 0, "SD-v2": 869, "NAI": 2982, "WD-VAE-v1": 155, "WD-VAE-v2": 41},
    "CLIP-v1": {
        "SD-v1": 0,
    },
    "CLIP-v2": {"SD-v2": 1141, "WD-v1-4": 2543},
}

COMPONENTS = {
    "UNET-v1-SD": {"keys": {}, "source": "UNET-v1-SD.txt", "prefix": "model.diffusion_model."},
    "UNET-v1-EMA": {"keys": {}, "source": "UNET-v1-EMA.txt", "prefix": "model_ema.diffusion_model"},
    "UNET-v1-Inpainting": {
        "keys": {},
    ...
    "UNET-v2-SD": {"keys": {}, "source": "UNET-v2-SD.txt", "prefix": "model.diffusion_model."},
    "UNET-v2-Inpainting": {
        "keys": {},
    ...
    "UNET-XL-SD": {"keys": {}, "source": "UNET-XL-SD.txt", "prefix": "model.diffusion_model."},
    "UNET-XL-Refiner": {
        "keys": {},
        "source": "UNET-XL-Refiner.txt",
        "prefix": "model.diffusion_model.",
    },
    "VAE-v1-SD": {"keys": {}, "source": "VAE-v1-SD.txt", "prefix": "first_stage_model."},
    "CLIP-v1-SD": {
        "keys": {},
    ...
    "CLIP-v2-SD": {"keys": {}, "source": "CLIP-v2-SD.txt", "prefix": "cond_stage_model.model."},
    "CLIP-v2-WD": {"keys": {}, "source": "CLIP-v2-WD.txt", "prefix": "cond_stage_model.model."},
    "CLIP-XL-SD": {
        "keys": {},
    ...
    "Depth-v2-SD": {"keys": {}, "source": "Depth-v2-SD.txt", "prefix": "depth_model.model."},
    "LoRA-v1-CLIP": {"keys": {}, "shapes": {}, "source": "LoRA-v1-CLIP.txt", "prefix": ""},
    "LoRA-v1A-CLIP": {"keys": {}, "shapes": {}, "source": "LoRA-v1A-CLIP.txt", "prefix": ""},
    "LoRA-v1-UNET": {"keys": {}, "shapes": {}, "source": "LoRA-v1-UNET.txt", "prefix": ""},
    "LoRA-v1A-UNET": {"keys": {}, "shapes": {}, "source": "LoRA-v1A-UNET.txt", "prefix": ""},
    "ControlNet-v1-SD": {
        "keys": {},
        "shapes": {},
...
ARCHITECTURES = {
    "UNET-v1": {"classes": ["UNET-v1"], "optional": [], "required": [], "prefixed": False},
    "UNET-v1-Pix2Pix": {
    ...
    "UNET-v2": {"classes": ["UNET-v2"], "optional": [], "required": [], "prefixed": False},
    "UNET-v2-Depth": {
    ...
    "UNET-XL": {"classes": ["UNET-XL-SD"], "optional": [], "required": [], "prefixed": False},
    "UNET-XL-Refiner": {
    ...
    "VAE-v1": {"classes": ["VAE-v1"], "optional": [], "required": [], "prefixed": False},
    "CLIP-v1": {"classes": ["CLIP-v1"], "optional": [], "required": [], "prefixed": False},
    "CLIP-v2": {"classes": ["CLIP-v2"], "optional": [], "required": [], "prefixed": False},
    "CLIP-XL": {"classes": ["CLIP-XL-SD"], "optional": [], "required": [], "prefixed": False},
    "CLIP-XL-AUX": {
    ...
    "Depth-v2": {"classes": ["Depth-v2"], "optional": [], "required": [], "prefixed": False},
    "ControlNet-v1": {
    ...
    "EMA-v1": {"classes": ["EMA-UNET-v1"], "optional": OPTIONAL, "required": [], "prefixed": True},
    "EMA-v1-Pix2Pix": {
    ...
    "UNET-v1-BROKEN": {"classes": ["UNET-v1"], "optional": [], "required": [], "prefixed": True},
    ...
    "UNET-v2-BROKEN": {"classes": ["UNET-v2"], "optional": [], "required": [], "prefixed": True},
    ...
    "VAE-v1-BROKEN": {"classes": ["VAE-v1"], "optional": [], "required": [], "prefixed": True},
    "CLIP-v1-BROKEN": {"classes": ["CLIP-v1"], "optional": [], "required": [], "prefixed": True},
    "CLIP-v2-BROKEN": {"classes": ["CLIP-v2"], "optional": [], "required": [], "prefixed": True},
    "Depth-v2-BROKEN": {"classes": ["Depth-v2"], "optional": [], "required": [], "prefixed": True},
    ...
    "LoRA-v1-UNET": {"classes": ["LoRA-v1-UNET"], "optional": [], "required": [], "prefixed": True},
    "LoRA-v1-CLIP": {"classes": ["LoRA-v1-CLIP"], "optional": [], "required": [], "prefixed": True},
    "LoRA-v1": {
...
def load_components(path):
    for c in COMPONENTS:
        file = files(path).joinpath(COMPONENTS[c]["source"])
...
def get_prefixed_keys(component):
    ...
    return {(prefix + k, z) for k, z in allowed}
...
def inspect_model(model, all=False):
    ...
    keys = {(k, tensor_shape(k, model[k])) for k in model}
    rejected = {}
    ...
    for comp in COMPONENTS:
        ...
        if missing_prefixed and missing_unprefixed:
            if missing_prefixed != required_keys_prefixed:
                rejected[comp] = rejected.get(comp, []) + [
                    {
                        "reason": f"Missing required keys ({len(missing_prefixed)} of {len(required_keys_prefixed)})",
                        "data": list(missing_prefixed),
                    }
                ]
            ...
            if missing_unprefixed != required_keys_unprefixed:
                rejected[comp] = rejected.get(comp, []) + [
                    {
                        "reason": f"Missing required keys ({len(missing_unprefixed)} of {len(required_keys_unprefixed)})",
                        "data": list(missing_unprefixed),
                    }
                ]
        else:
    ...
    for arch in ARCHITECTURES:
        ...
        if not required_keys.issubset(keys):
            ...
            if missing != required_keys:
                rejected[arch] = rejected.get(arch, []) + [
                    {
                        "reason": f"Missing required keys ({len(missing)} of {len(required_keys)})",
                        "data": list(missing),
                    }
                ]
            continue
            ...
            if clss in classes:
                for comp in classes[clss]:
                    if (
                        comp,
                        needs_prefix,
                    ) in components:  # or ((comp, not needs_prefix) in components and not needs_prefix):
...
def contains_component(model, component, prefixed=None):
    model_keys = {(k, tensor_shape(k, model[k])) for k in model}

    allowed = False
    if prefixed is None:  # prefixed or unprefixed
...
def get_allowed_keys(arch, allowed_classes=None):
    ...
    for a in arch:
        ...
        for clss in arch[a]:
            if allowed_classes is None or clss in allowed_classes:
...
def fix_model(model, fix_clip=False):
    ...
    for k in list(model.keys()):
        for r in nai_keys:
            if type(k) is str and k.startswith(r):
...
def prune_model(model, arch, keep_ema, dont_half):
    ...
    for k in list(model.keys()):
        ...
        if not keep:
            del model[k]
            continue
        if type(model[k]) is torch.Tensor:
...
def replace_component(target, target_arch, source, source_component):
    if COMPONENT_CLASS[source_component] not in ARCHITECTURES[target_arch]["classes"]:
...
#     path = 'sup_toolbox.tools.model_toolkit.components'
