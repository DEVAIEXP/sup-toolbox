<#
.SYNOPSIS
    Setup script for the sup-toolbox project.
.DESCRIPTION
...
# ============================================================================
#  Setup Script for sup-toolbox (PowerShell Version)
# ============================================================================
...
Write-Host ""
Write-Host "Installing the sup-toolbox package in editable mode..."
# Editable install is great for development as code changes are reflected immediately.
pip install -e .
if ($LASTEXITCODE -ne 0) {
    Exit-OnError "Failed to install the project in editable mode. Check your pyproject.toml for errors."
}
