# ControlNetTile inference with SUP Toolbox Pipeline
# This script demonstrates how to use the Controlnet model with sup_toolbox library
...
config.upscaler_pipeline_params.seed = 42
...
config.upscaler_pipeline_params.upscale_factor = "2x"
config.upscaler_pipeline_params.prompt = "high-quality, noise-free edges, high quality, 4k, hd, 8k"
config.upscaler_pipeline_params.negative_prompt = "blurry, pixelated, noisy, low resolution, artifacts, poor details"
config.upscaler_pipeline_params.num_images = 1
config.upscaler_pipeline_params.num_steps = 35
config.upscaler_pipeline_params.tile_size = 1024
config.upscaler_pipeline_params.tile_overlap = 256
config.upscaler_pipeline_params.strength = 0.65
...
config.upscaler_pipeline_params.image_size_fix_mode = ImageSizeFixMode.ProgressiveResize
config.upscaler_pipeline_params.upscaling_mode = UpscalingMode.Progressive
config.upscaler_pipeline_params.tile_weighting_method = WeightingMethod.Cosine
config.upscaler_pipeline_params.cfg_decay_rate = 0.5
config.upscaler_pipeline_params.strength_decay_rate = 0.5
config.image_path = load_image("./assets/samples/1.jpg")
